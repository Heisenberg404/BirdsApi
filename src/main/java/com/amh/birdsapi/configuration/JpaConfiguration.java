package com.amh.birdsapi.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.amh.birdsapi.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.amh.birdsapi.model" });
